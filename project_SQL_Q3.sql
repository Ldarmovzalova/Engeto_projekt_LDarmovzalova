...
select *
from czechia_price; -- kontrola obsahu tabulky, abych si připravila, které sloupce budu dál potřebovat
...
select *
from t_lucie_darmovzalova_help_table_prumery_cen; -- kontrola, zda se vytvořila tabulka správně
